brandApp.controller("goodsEditController",function($scope,$controller,$location,goodsEditService,itemCatService,typeTemplateService,$http){
...
//		}
		...
		$scope.updateStatus=function(status){
			...
			goodsEditService.updatestatus($scope.selectIds,status).success(function(resp){
				if(resp.status){
					alert("操作成功");
					$scope.reloadList();
					$scope.selectIds=[];
