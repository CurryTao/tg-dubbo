...
<body ng-app="brandApp" ng-controller="itemController" ng-init="num=1;loadSku()">
						...
						<div class="summary-wrap">
							...
							<div class="fl fix-width">
								<#list promotionList as promotion>
									<i class="red-bg">${promotion.typename}</i>
									<em class="t-gray">${promotion.title} &nbsp; ${promotion.content}</em><br/>
								</#list>
								<#if giftList??>
									<i class="red-bg">赠品</i>
										<#list giftList as gift>
											<em class="t-gray">${gift.goodsName}</em>
											<em class="t-gray"> 一件 </em><br/>
										</#list>
								</#if>
							</div>
						</div>
